<h2>In your cart ({{ Cart::content()->count() }})</h2>
<ul class="order-history">
    ...
    <li class="order-details">
        <span>Shipping Charge <span id="shipping_percent">({{ round(shoppingChargeDefault()) }} %)</span>:</span>
        <span id="shopping_amount">৳ {{round($shopping_charge) }}</span>
    </li>

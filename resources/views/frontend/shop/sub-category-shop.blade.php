        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
                <div class="all-filter">
                    ...
                    <div class="categories-page-filter">
                        <h4 class="filter-title">Re Sub Category</h4>
                        <a href="#category-filter" data-bs-toggle="collapse" class="filter-link"><span>Re Sub Category
                        ...
                        <ul class="all-option collapse" id="category-filter">
                            ...
                            <li class="grid-list-option">
                                <input type="checkbox" class=" re_sub_category common_selector" name="re_sub_category"
                                    id="{{ $re_sub_category->id }}" value="{{ $re_sub_category->id }}">
                                <label for="{{ $re_sub_category->id }}" style="margin-left: 5px;">{{
            ...
            <div class="col-lg-9 col-md-8 col-12">
                ...
                <div class="grid-list-banner"
                    style="background-image: url({{ asset($subCategory->image ? 'uploads/subcategory/'.$subCategory->image : 'frontend/image/slider17.jpg')}});">

                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ url('admin/update/order') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $vendor_name=App\Models\User::where('id',$product_details->user_id)->first();
                                                        @endphp
                                                        {{ $vendor_name->name }}
                                                        <br>
                                                        {{ $vendor_name->phone }}
                                                    ...
                                                    <td>
                                                        <input type="text" id="product_{{$key}}" name="qty[]"
                                                            value="{{ $mainpro->qty }}"
                                                            onchange="calculateSubTotal({{$key}})">
                                                    </td>
                                                    ...
                                                    <input type="hidden" name="company_id[]"
                                                        value="{{ $company_product->shop_id }}">
                                                    <input type="hidden" name="product_name[]"
                                                        value="{{ $mainpro->product_name }}">

                                                    <input type="hidden" name="image[]" value="{{ $mainpro->image }}">
                                                    <input type="hidden" name="sku[]" value="{{ $mainpro->sku }}">
                                                    <input type="hidden" name="shop_id[]"
                                                        value="{{ $mainpro->shop_id }}">
                                                    <input type="hidden" name="price[]"
                                                        class="product_main_price_{{$key}}"
                                                        value="{{ $mainpro->price }}">
                                                    <input type="hidden" name="subtotal[]"
                                                        class="product_subtotal_price_{{$key}}"
                                                        value="{{ $mainpro->subtotal }}">
                                                    <td class="subtotal_price_{{$key}}">{{ $mainpro->subtotal }}</td>

                                                    <td>
                                                        <a onclick="deleterow(this)" href="#" class="btn-sm"
                                                            style="color:red">

    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Coupon</h1>
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Coupon</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                            ...
                            <div class="col-md-2 text-right">
                                ...
                                <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ route('admin.cuppon.index') }}" class="btn btn-primary">All Coupon</a>
                                </div>
                            </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.cuppon.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main"
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Coupon Code:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="cuppon_code" value="{{ $cuppon->cuppon_code }}">
                                                    <input type="hidden" name="id" value="{{ $cuppon->id }}">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Amount:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="number"
                                                        name="amount" placeholder="Coupon Amount"
                                                        value="{{ $cuppon->amount }}">
                                                </div>
                                                @error('amount')
                                                <div class="validation">{{ $message }}</div>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Amount Type:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    ...
                                                    <select name="amount_type"
                                                        ...
                                                        <option @if ($cuppon->amount_type == 'taka') selected @endif
                                                            value="taka">Taka</option>
                                                        <option @if ($cuppon->amount_type == 'parcent') selected @endif
                                                            value="parcent">Percent</option>
                                                    </select>
                                                </div>
                                                @error('amount_type ')
                                                <div class="validation">{{ $message }}</div>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Date:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid kt_datepicker_!"
                                                        type="date" name="date" value="{{ $cuppon->date }}">
                                                </div>
                                                @error('date')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror

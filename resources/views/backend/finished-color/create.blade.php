...
@section('title', 'Create finished color')
@section('content')
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create finished color</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                            ...
                            <div class="col-md-2 text-right">
                                ...
                                <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ route('admin.finished-color.index') }}" class="btn btn-primary">All
                                        finished
                                        color</a>
                                </div>
                            </div>
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.finished-color.store') }}" enctype="multipart/form-data">
                            @csrf

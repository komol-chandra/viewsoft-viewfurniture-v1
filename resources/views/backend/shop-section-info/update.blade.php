...
<link type="text/css" rel="stylesheet" href="{{asset('assets/custom/css/image-uploader.min.css')}}">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Shop Section</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Edit Shop Section</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                        ...
                        <div class="card-header card-header-stretch overflow-auto row text-right">
                            ...
                            <div class="col-md-2 text-right">
                                ...
                                <div class="mt-5" style="margin-left: 75px">
                                    <a href="{{ route('admin.about-shop-page-info.index') }}"
                                        class="btn btn-primary">All </a>
                                </div>
                            </div>
                        </div>
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.about-shop-page-info.update',$option->id) }}"
                            ...
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main"
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Title Key:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    ...
                                                    <input class="form-control form-control-solid" type="text" name=""
                                                        placeholder="Enter Title" value="{{ $option->title_key }}"
                                                        disabled>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="description" placeholder="Enter Brand description"
                                                        value="{{ $option->title }}">
                                                    ...
                                                    <div style="position: relative;">
                                                        ...
                                                        <label class="file_upload"
                                                            ...
                                                            <img style="width: 100%; margin: 0px auto; vertical-align: middle; display: ;"
                                                                ...
                                                                src="{{asset('uploads/shop-section/'.$option->cover)}}">
                                                            <input class="form-control spartan_image_input"
                                                                accept="image/*" data-spartanindexinput="0"
                                                                style="display : none" name="cover" type="file">
                                                        </label>
                                                    </div>
                                                </div>
                                                <div id="cover_img" style="display: none;"></div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#icon_img").spartanMultiImagePicker({
            fieldName: 'icon',
            maxCount: 1,
            rowHeight: '250px',
        ...
        $("#cover_img").spartanMultiImagePicker({
            fieldName: 'cover',
            maxCount: 1,
            rowHeight: '250px',
            groupClassName: 'col-xl-12 col-md-12 col-sm-12 col-xs-12',

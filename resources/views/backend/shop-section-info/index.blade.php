        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Shop Section Manage</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Shop Section</span>
                            </h3>
                            <div class="card-toolbar">

                                {{-- <a href="{{ url('admin/about-shop-page-info/create') }}"
                                class="btn btn-sm btn-primary">Create Shop
                                Section</a> --}}
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-120px">Cover</th>
                                            <th class="min-w-120px">Status</th>
                                            <th class="min-w-100px text-end">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-center">
                                        @foreach($shopSections as $key => $data)
                                        <tr>
                                            <td class="text-dark fw-bolder text-hover-primary fs-6"> {{ ++$key }} </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->title_key  }}</a>
                                            </td>
                                            <td>
                                                <img src="{{asset('uploads/shop-section/'.$data->cover)}}"
                                                    height="25px">
                                            </td>
                                            ...
                                            <td class="text-end">
                                                {{-- @if($data->is_active==1)
                                                <a href="{{url('admin/about-shop-page-info/status/'.$data->id)}}"
                                                ...
                                                @endif --}}
                                                <a href="{{url('admin/about-shop-page-info/edit/'.$data->id)}}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">

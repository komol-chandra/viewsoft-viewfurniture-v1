        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Shop Section</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.about-shop-page-info.store') }}" enctype="multipart/form-data">
                            @csrf
...
<script>
    $(document).ready(function () {
        ...
        $("#shop_section_img").spartanMultiImagePicker({
            fieldName: 'cover',
            maxCount: 1,
            rowHeight: '450px',

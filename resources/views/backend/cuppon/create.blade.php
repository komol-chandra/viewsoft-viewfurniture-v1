        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Coupon</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.cuppon.create') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane active" id="kt_builder_main"
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    ...
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="cuppon_code" placeholder="Coupon Name">
                                                </div>
                                                @error('cuppon_code')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid kt_datepicker_1"
                                                        type="text" name="date" placeholder="Coupon Name">
                                                </div>
                                                @error('date')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror

    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">All Order Coommission</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Order Commission Product</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Commission Product</span>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%">
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Product ID</th>
                                            <th class="min-w-140px">Total Qty</th>
                                            <th class="min-w-140px">Total Price</th>
                                            <th class="min-w-140px">Commission</th>
                                            <th class="min-w-140px">Vendor Payable</th>
                                    ...
                                    @foreach($alldata as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" >{{ $data->product_id  }}</a>
                                            </td>
                                            <td>
                                                <a href="#" >{{ $data->product_qty  }}</a>
                                            </td>
                                            <td>
                                                <a href="#" >{{ $data->product_price  }}</a>
                                            </td>
                                            <td>
                                                <a href="#" >{{ $data->shop_commission  }}</a>
                                            </td>
                                           
                                            <td>
                                                <a href="#">{{ $data->vendor_payable }}</a>
                                            </td>
                                            <td>{{ $data->website_payable }}</td>

                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('admin/color/create') }}" class="btn btn-sm btn-primary">Create
                                    Color</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">Color Code</th>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->color_name }}</a>
                                            </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->color_code }}</a>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                @if ($data->is_active == 1)
                                                <a href="{{ url('admin/color/status/' . $data->id) }}"

            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                        ...
                        $data = App\Models\Order::where('order_status', 0)->count();
                        ...
                        <div
                            ...
                            <div class="menu-item me-lg-1">
                                <a class="menu-link active py-3" href="{{ route('admin.unapproved-vendor.index') }}">
                                    <span class="menu-title">Vendor Requests <span
                                            class="badge badge-secondary">{{$vendor_requests_count}}</span></span>
                        ...
                        <div
                            class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch">
                            <div class="menu-item me-lg-1">
                                <a class="menu-link active py-3" href="{{ route('admin.approve.product') }}">
                                    <span class="menu-title">Approve Products<span
                                            class="badge badge-secondary">{{$pendingcount}}</span></span>
                        ...
                        <div
                            class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch">
                            <div class="menu-item me-lg-1">
                                <a class="menu-link active py-3" href="{{ route('admin.reject.product') }}">
                                    <span class="menu-title">Rejected Products<span
                                            class="badge badge-secondary">{{$rejectcount}}</span></span>
                        ...
                        <div
                            ...
                            <div class="menu-item me-lg-1">
                                <a class="menu-link active py-3"
                                    ...
                                    <span class="menu-title">Custom choose<span
                                            class="badge badge-secondary">{{$custom_product_count}}</span></span>
                            ...
                            <div class="menu-item me-lg-1">
                                <a class="menu-link active py-3" href="{{ url('admin/neworder/list') }}">
                                    <span class="menu-title">Orders<span
                                            class="badge badge-secondary">{{$data}}</span></span>

                                </a>
                            </div>
                        </div>
                        <div
                            class="menu-link active menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch">
                            <div class="menu-item me-lg-1 ">
                                <a class="menu-link active py-3" href="{{ url('/clear-app') }}"
                                    style="background-color: #e63909;">
                                    <span class="menu-title" style="color:white;"> App Cache Clear<span
                    ...
                    <div class="symbol symbol-40px me-4">
                        <span class="symbol-label bg-light">
                            <img class="w-20px h-20px"
                                src="{{asset('backend')}}/assets/media/svg/brand-logos/volicity-9.svg" alt="" />
                        </span>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
            ...
            <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="d-flex flex-column">
                    <div class="fw-bolder d-flex align-items-center fs-5">{{Auth::user()->user_name}}
                        ...
                        <span
                            class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{Auth::user()->designation}}</span>
                    </div>
                    {{-- @endif   --}}

                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="{{ url('admin/re-re-resubcategory/create') }}"
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->name  }}</a>
                                            </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->Category_id ? $data->Category_id->name : ''  }}</a>
                                            </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->SubCategory_id ? $data->SubCategory_id->name : ''  }}</a>
                                            </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->ReSubCategory_id ? $data->ReSubCategory_id->name : '' }}</a>
                                            </td>
                                            <td>
                                                <a href="#"
                                                    class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->ReReSubCategory_id ? $data->ReReSubCategory_id->name :''  }}</a>
                                            </td>
                                            <td>
                                                @if($data->is_active==1)
                                            ...
                                            <td class="text-end">
                                                @if($data->is_active==1)
                                                <a href="{{url('admin/re-re-resubcategory/deactive/'.$data->id)}}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <i class="fa fa-thumbs-up green"></i>
                                                </a>
                                                @else
                                                <a href="{{url('admin/re-re-resubcategory/active/'.$data->id)}}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <i class="fa fa-thumbs-down red"></i>
                                                </a>
                                                @endif
                                                <a href="{{url('admin/re-re-resubcategory/edit/'.$data->id)}}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <i class="fas fa-pen-square blue"></i>
                                                </a>
                                                <a id="delete"
                                                    href="{{url('/admin/re-re-resubcategory/delete/'.$data->id)}}"

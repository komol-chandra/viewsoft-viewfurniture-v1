    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">All Shops</h1>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">All Shops Manage</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Shops</span>
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="dataTableExample1" class="data-table" style="width:100%">
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">shop name</th>
                                    ...
                                    @foreach($shops as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#">{{Str::limit($data->shop_name, 20)}}</a>
                                            </td>
                                            <td>
                                                <a href="#">{{ $data->phone  }} </a>
                                            </td>
                                            <td style="width: 5%">
                                                <div class="row">
                                                <div class="col-md-12">
                                                    @if($data->commission_percent =='0' && $data->is_approve=='0' )
                                                    <form class="form" method="POST" id="kt_layout_builder_form" action="{{ url('/admin/approvewithcommision/allshop') }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-md-9">
                                                            <input type="number" max="90" min="1" class="form-control" name="percent" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="hidden" style="height: 70%" name="id" value="{{ $data->id }}" id="">
                                            ...
                                            <td class="text-end">
                                                @if($data->commission_percent =='0')
                                                @else
                                                    @if($data->is_approve==0)
                                                    
                                                    <a href="{{url('/admin/allshop/approve/'.$data->id)}}"  class="btn btn-icon btn-bg-warning btn-active-color-primary btn-sm me-1">
                                                        <i class="fas fa-thumbs-up blue"></i>
                                                    </a>
                                                    @elseif($data->is_approve==1)
                                                    <a href="{{url('/admin/allshop/approve/'.$data->id)}}"  class="btn btn-icon btn-bg-primary  btn-sm me-1">
                                                        <i class="fas fa-thumbs-up blue"></i>
                                                    </a>
                                                    @endif
                                                @endif
                                                <a href="{{url('/admin/allshop/edit/'.$data->id)}}"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">

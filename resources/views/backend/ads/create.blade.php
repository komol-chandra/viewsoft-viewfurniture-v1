        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Create Ads</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.ads.create') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    ...
                                                    <select class="form-control form-control-solid"
                                                        ...
                                                        <option value="details_sidebar">Details Sidebar(313x480)
                                                        </option>
                                                        <option value="popup">Pop up(750x250)</option>
                                                        <option value="footer">Footer(1350x110)</option>
                                                        <option value="category_header">Category Header(1350x110)
                                                        </option>
                                                        <option value="category_footer">Category Footer(1350x110)
                                                        </option>
                                                    </select>
                                                </div>
                                                @error('ads_section')

    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Ads</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Ads</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.ads.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main"
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Ads Section:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select class="form-control form-control-solid"
                                                        style="padding-bottom: 0px" name="ads_section">
                                                        {{-- <option value="" selected>Select</option> --}}
                                                        <option @if ($edit->ads_section == 'details_sidebar') selected
                                                            @endif
                                                            value="details_sidebar">Details
                                                            Sidebar(313x480)</option>
                                                        <option value="popup" @if($edit->ads_section == 'popup')
                                                            selected @endif>Pop up(1350x110)</option>
                                                        <option @if ($edit->ads_section == 'footer') selected @endif
                                                            value="footer">Footer(1350x110)
                                                        </option>
                                                        <option @if ($edit->ads_section == 'category_header') selected
                                                            @endif
                                                            value="category_header">Category
                                                            Header(1350x110)
                                                        </option>
                                                        <option @if ($edit->ads_section == 'category_footer') selected
                                                            @endif
                                                            value="category_footer">Category
                                                            Footer(1350x110)
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Ads Url:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Ads Limit:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="add_limit" value="{{ $edit->add_limit }}">
                                                </div>
                                                @error('add_limit')
                                                <div class="validation">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Ads Image:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url({{ asset('uploads/ads/' . $edit->image) }})">
                                                    </div>

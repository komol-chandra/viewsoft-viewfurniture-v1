                            ...
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main"
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Type:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <select name="type" id="" class="form-control border-form-control"
                                                        style="height: 40px" required="">
                                                        <option value="" disabled selected>Select
                                                        </option>
                                                        <option value="offer_11"
                                                            {{ $edit->type =='offer_11' ? 'selected':'' }}>11
                                                            offer
                                                        </option>
                                                        <option value="offer_22"
                                                            {{ $edit->type =='offer_22' ? 'selected':'' }}>22 offer
                                                        </option>
                                                        <option value="offer_special"
                                                            {{ $edit->type =='offer_special' ? 'selected':'' }}>special
                                                            offer</option>
                                                    </select>
                                                </div>
                                                @error('type')
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text"
                                                        name="url" placeholder="Enter Banner Url"
                                                        value="{{ $edit->url }}">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Short
                                                Description:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea class="form-control" type="text" name='short_desc'
                                                        rows="3">{{ $edit->short_desc }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url({{asset('uploads/banner/'.$edit->image)}})">
                                                    </div>

                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form"
                            action="{{ route('admin.banner.create') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="col-lg-9 col-xl-4">
                                                <div
                                                    ...
                                                    <select name="type" id="" class="form-control border-form-control"
                                                        ...
                                                        <option value="offer_11">11 offer</option>
                                                        <option value="offer_22">22 offer</option>
                                                        <option value="offer_special">special offer</option>
                                                    </select>
                                                </div>
                                                @error('type')
                                                <div class="validation">{{ $message }}</div>
